...
import { FaEllipsisH, FaOsi } from 'react-icons/fa';
          ...
          <NavItem>
            <Link className="btn btn-xs btn-border btn-circle" to="#">
              <Button type="button" className="auth-link-btn">
                ...
                <div className="log-icon"><BsPower /></div>
                <div>logout</div>
                </div>
              </Button>
            </Link>
          ...
          <NavItem>
            <div className="profile-info">
                <div className="d-flex">
                    <div className="red-color"><FaOsi/>&nbsp;</div>
                    <div>gratien tuyishimire</div>
                </div>
                <div className="d-flex">
                    <div className="red-color"><BsPhone/> &nbsp;</div>
                ...
                <Nav vertical>
                    <NavItem>
                        <Link className="nav-link" to="#">
                            <div className="d-flex">
                            <div className="pr-2"><BsFileEarmarkCheck/></div>
                            <div> + students</div>
                            </div>
                        </Link>
                    </NavItem>
