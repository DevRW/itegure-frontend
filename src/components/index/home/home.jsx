            ...
            <Col md="6">
              <div className="mt-5 intro">
                <div className="w-div">
                  ...
                  <div className="font-weight-bold sub-title">to learning reminder</div>
                </div>
                ...
                <div className="mt-5 l-about">
                  <div className="mt-4">Contact us <div className="home-icon"><i><BsTablet/></i> &nbsp;0788767670</div> 
                  <div className="home-icon"><i><BsBriefcase/></i> &nbsp;info@reminder.com</div></div>
                  <div className="mt-4">
                    All right reserved <div className="home-icon"><i><BsAt/></i>{new Date().getFullYear()}</div>
                  </div>
                </div>
              </div>
            </Col>
